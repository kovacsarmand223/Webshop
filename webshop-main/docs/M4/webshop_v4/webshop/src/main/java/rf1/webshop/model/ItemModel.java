...
public class ItemModel implements Serializable {
    ...
    public ItemModel(String name, String manufacturer, String description, int price, boolean available, String country, int rating) {
        this.name = name;
        this.manufacturer = manufacturer;
        this.description = description;
        this.price = price;
    ...
    public ItemModel(String name, int price, boolean available, int rating) {
        this.name = name;
        this.price = price;
        this.available = available;
        this.rating = rating;
