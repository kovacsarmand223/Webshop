...
--
-- Gép: 127.0.0.1
-- Létrehozás ideje: 2023. Nov 10. 16:38
...
INSERT INTO `termek` (`termekazonosito`, `nev`, `gyarto`, `leiras`, `ar`, `elerhetoe`, `szarmazasiorszag`, `osztalyzas`) VALUES
                                                                                                                             (1, 'Laptop', 'Acer', 'Ez egy nagyon megbízható laptop', 100000, 1, 'Tajvan', 8),
                                                                                                                             (2, 'Laptop', 'Asus', 'Ez a legnagyobb élettartamú laptop', 150000, 1, 'Tajvan', 9);
