...
public class ItemDAO extends JdbcDaoSupport {
    ...
    public void createItem(ItemModel itemModel){
        String sql = "INSERT INTO termek(termekazonosito, nev, gyarto, leiras, ar, elerhetoe, szarmazasiorszag, osztalyzas) VALUES (?,?,?,?,?,?,?,?)";
    ...
    public void createItem(ItemModel itemModel, boolean missingData){
        ...
        String sql = "INSERT INTO termek(termekazonosito, nev, ar, elerhetoe, osztalyzas) VALUES (?,?,?,?,?)";
        getJdbcTemplate().update(sql, new Object[] {
                itemModel.getItemId(),
                itemModel.getName(),
                itemModel.getPrice(),
